...
subLabels1 = a[:2]
subLabels2 = a[2:]
print('subLabels1===', subLabels1)
print('subLabels2===', subLabels2)
...
print('# 按年龄排序', sorted(student_tuples, key=lambda student: student[2]))

'''
[1, 2, 3, 4, 5]
[5, 4, 3, 2, 1]
['a', 'Andrew', 'from', 'is', 'string', 'test', 'This']
# 按年龄排序 [('jane', 'B', 62), ('john', 'A', 75), ('dave', 'B', 100)]
'''
